...
var src_default = class {
  ...
  screenShot(filename) {
    return __async(this, null, function* () {
      yield this.page.screenshot({ path: `./screenshot/${filename}.png`, fullPage: true });
    });
  }
  navigate(url) {
    return __async(this, null, function* () {
  ...
  attemptLogin() {
    return __async(this, null, function* () {
      yield this.navigate(constatnts_default.URL.LOGIN);
      ...
      yield this.screenShot("login");
    });
  }
  goToSpecifiedApp(appId) {
    return __async(this, null, function* () {
      yield this.navigate(`${constatnts_default.URL.BASE_URL}/k/${appId}`);
      yield this.page.waitForSelector("div.gaia-argoui-app-viewtoggle");
      yield this.screenShot("app");
    });
  }
  gotoSpecifiedRecord(appId, recordId) {
    return __async(this, null, function* () {
      yield this.navigate(`${constatnts_default.URL.BASE_URL}/k/${appId}/show#record=${recordId}`);
      yield this.page.waitForSelector("div.gaia-argoui-optionmenubutton.gaia-argoui-app-menu-option");
      yield this.screenShot("record");
    });
  }
  gotoCreateRecord(appId) {
    return __async(this, null, function* () {
      yield this.navigate(`${constatnts_default.URL.BASE_URL}/k/${appId}`);
      yield this.page.locator('a[title="\u30EC\u30B3\u30FC\u30C9\u3092\u8FFD\u52A0\u3059\u308B"]').click();
      yield this.page.waitForSelector("div.gaia-argoui-app-edit-buttons");
      yield this.page.waitForTimeout(1e3);
      yield this.screenShot("edit");
    });
  }
  editRecord(record) {
    return __async(this, null, function* () {
